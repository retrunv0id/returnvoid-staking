...
var e = Symbol(), t = Symbol(), r$1 = "a", n = "w";
var o$1 = (e, t) => new Proxy(e, t), s = Object.getPrototypeOf, c$1 = /* @__PURE__ */ new WeakMap(), l = (e) => e && (c$1.has(e) ? c$1.get(e) : s(e) === Object.prototype || s(e) === Array.prototype), f = (e) => "object" == typeof e && null !== e, i = (e) => {
	if (Array.isArray(e)) return Array.from(e);
	const t = Object.getOwnPropertyDescriptors(e);
	return Object.values(t).forEach((e) => {
		e.configurable = !0;
	}), Object.create(s(e), t);
}, u = (e) => e[t] || e, a$1 = (s, c, f, p) => {
	if (!l(s)) return s;
	let g = p && p.get(s);
	if (!g) {
		const e = u(s);
	...
	return w && w[1].f === !!h || (w = ((o, s) => {
		...
		const f = (e, t) => {
			if (!l) {
				let s = c[r$1].get(o);
				if (s || (s = {}, c[r$1].set(o, s)), e === n) s[n] = !0;
				else {
					let r = s[e];
			...
			get: (e, n) => n === t ? o : (f("k", n), a$1(Reflect.get(e, n), c[r$1], c.c, c.t)),
			has: (t, n) => n === e ? (l = !0, c[r$1].delete(o), !0) : (f("h", n), Reflect.has(t, n)),
	...
	})(y, !!h), w[1].p = o$1(h || y, w[0]), f && f.set(y, w)), w[1][r$1] = c, w[1].c = f, w[1].t = p, w[1].p;
}, p$1 = (e, t, r, o) => {
	...
	try {
		...
		for (const n of s.k || []) if (c = p$1(e[n], t[n], r, o), c) return c;
		return null === c && (c = !0), c;
	} finally {
		o && o.set(e, {
			n: t,
...
//#endregion
//#region node_modules/@walletconnect/modal-core/dist/index.js
var o = proxy({
	...
	formatNativeUrl(e, t, s) {
		...
		return `${n}wc?uri=${encodeURIComponent(t)}`;
	},
...
var L = "https://explorer-api.walletconnect.com", E = "wcm", O = "js-2.6.2";
...
var N = a.isMobile(), d = proxy({
	...
	async getRecomendedWallets() {
		...
		if (a.isArray(e)) {
			...
			i.sort((l, v) => {
				return e.indexOf(l.id) - e.indexOf(v.id);
...
var C = proxy({ themeMode: Z() ? "dark" : "light" }), ne = {
	state: C,
	subscribe(e) {
		return subscribe(C, () => e(C));
	},
...
//#endregion
export { oe as a, te as c, ne as i, y as l, T as n, p as o, a as r, se as s, R as t };

//# sourceMappingURL=dist-CwjXNmJj.js.map